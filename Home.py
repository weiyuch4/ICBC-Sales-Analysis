...
st.markdown("# ICBC Sales Analysis :bookmark_tabs:")
st.subheader("Sussex Insurance Agency (160 St)")
...
st.markdown(
    ...
    - Enables pattern recognition and generates a histogram for enhanced visualization by classifying financial 
    transactions based on their occurrence time and day of the week
    ...
    - Collect and examine the cumulative sales data up to the current date, and compare it with the sales data from 
    the same date in the previous year for the specified year
    """
)
